      ...
      <div className={`drawer fixed h-full left-0 top-0 bottom-0  w-0 z-20 ${isOpen ? "drawer-open" : ""}`}>
        ...
        <div className="drawer-side h-full">
          ...
          <ul className="menu bg-base-200 text-base-content min-h-full w-80 p-4">
            ...
            <hr className="my-2 border-gray-500" />
            <li className="dropdown dropdown-hover">
              <label tabIndex={0}>Unités de tarification/Options de location</label>
              <ul
              tabIndex={0}
              className="menu dropdown-content bg-base-100 rounded-box z-[1] w-52 p-2 shadow mt-2 ml-20"
              >
                <li><Link to="/members-dashboard/unitésdetarification">Unités de tarification</Link></li>
                <hr className="my-2 border-gray-500" />
                <li><Link to="/members-dashboard/optionsdelocation">Options de location</Link></li>
              </ul>
            </li>
            <hr className="my-2 border-gray-500" />
            <li className="dropdown dropdown-hover">
